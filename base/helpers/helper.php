...
class JnRadHelper
{
	...
	/**
	 * Throws an exceptions if an API method is not enabled from jnrad vars
	 *
	 * @param    array    $jnrad_vars   Rad vars
	 * @param    string   $method       Task name
	 *
	 * @return   void
	 *
	 */
	public static function checkEnabledApi($jnrad_vars, $method){
		if(!$jnrad_vars["enabled_api"][$method]){
			throw new Exception("API Method disabled: $method", 500);
		}
	}
